  ...
  head: () => ({
    meta: [
      ...
      { title: "testbricks — Run Databricks workflows locally" },
      {
        name: "description",
        content:
          "testbricks runs Databricks workflows on your laptop with powerful mocks: SparkProxy routing delta tables to CSV, a drop-in dbutils replacement, and a workflow runner that executes notebooks in dependency order.",
      },
      { name: "author", content: "testbricks" },
      { property: "og:title", content: "testbricks — Run Databricks workflows locally" },
      {
